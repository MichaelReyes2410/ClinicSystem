...
Public Class frm_GuestDashboardAdmin
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs)
        Try
            reloadtxt("DELETE FROM patient_record_staff WHERE faculty_id='" & DataGridView1.CurrentRow.Cells(1).Value.ToString() & "' ")
    ...
    Private Sub frm_GuestDashboardAdmin_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub frm_GuestDashboardAdmin_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Application.Exit()
    End Sub
End Class