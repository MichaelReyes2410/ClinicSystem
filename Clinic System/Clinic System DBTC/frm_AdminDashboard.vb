...
Public Class frm_AdminDashboard
    ' Add a property to store the currently logged-in admin's username
    Public Property AdminMain As String
    ...
    ' Centralize the panel navigation logic for code reusability
    ...
    ' Sample method for checking unsaved changes (you should implement this logic)
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles btnBackupDB.Click
    ...
    Private Sub frm_AdminDashboard_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' Initialize the dashboard with a welcome message
        Label1.Text = "Welcome To Don Bosco Clinic, " & AdminMain & "!"
    ...
    Private Sub frm_AdminDashboard_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Application.Exit()
    End Sub
End Class
